...
//contar quantos caracteres minusculos existe na string
int contar_min(char *str)

//contar quantos caracteres numericos existe na string
...
//ordene os caracteres de uma string pelo codigo asc
